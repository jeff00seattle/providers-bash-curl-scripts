...
# read the options
OPTS=`getopt -o hv --long help,verbose,file:,parent: -n 'post_user_drive_parent_file_upload.sh' -- "$@"`
...
API_VERSION="v1.0"
PATHNAME="${API_VERSION}/me/drive/items/${PARENT_ID}:/${FILE_BASENAME}:/content"
