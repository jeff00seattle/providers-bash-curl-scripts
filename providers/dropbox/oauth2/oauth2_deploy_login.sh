...
LOGIN_URL="${AUTH_URL}?response_type=code&client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&disable_signup=true&force_reapprove=true&force_reauthentication=true&state=${SECURITY_TOKEN}"
