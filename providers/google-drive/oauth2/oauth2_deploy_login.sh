...
LOGIN_URL="${AUTH_URL}?response_type=code&access_type=offline&prompt=consent&&client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&scope=${AUTH_SCOPE}&state=${SECURITY_TOKEN}"
