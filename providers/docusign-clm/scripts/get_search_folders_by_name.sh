...
# read the options
OPTS=`getopt -o hvp --long help,verbose,parse,name: -n 'get_folder_by_name.sh' -- "$@"`
...
CURL_URL="${SPRINGCM_API_BASE_URL}/${SPRINGCM_API_VERSION}/${DOCUSIGN_ACCOUNT_ID}/folders?search=${FOLDER_NAME}&expand=path,lock,parentfolder,attributegroups"
