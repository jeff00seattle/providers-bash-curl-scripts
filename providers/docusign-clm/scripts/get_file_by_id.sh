...
# read the options
OPTS=`getopt -o hv --long help,verbose,random,parse,id: -n 'get_file_by_id.sh' -- "$@"`
...
CURL_URL="${SPRINGCM_API_BASE_URL}/${SPRINGCM_API_VERSION}/documents/${FILE_ID}"

source ./curl/curl_get_file_by_id.sh
