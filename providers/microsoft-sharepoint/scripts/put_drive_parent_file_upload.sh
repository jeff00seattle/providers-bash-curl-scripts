...
# read the options
OPTS=`getopt -o hv --long help,verbose,file:,parent:,drive: -n 'put_drive_parent_file_upload.sh' -- "$@"`
...
API_VERSION="v1.0"
PATHNAME="${API_VERSION}/drives/${DRIVE_ID}/items/${PARENT_ID}:/${FILE_BASENAME}:/content"

source ./curl/curl_put_drive_file_upload.sh
